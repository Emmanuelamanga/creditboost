          ...
          <div className="md:w-7/12 lg:w-1/2">
            ...
            <div className="divide-y space-y-4 divide-gray-100 dark:divide-gray-800">
              <div className="mt-8 flex gap-4 md:items-center">
                ...
                <div className="w-5/6">
                  <h3 className="font-semibold text-lg text-gray-700 dark:text-indigo-300">Expert Advice Anytime</h3>
              ...
              <div className="pt-4 flex gap-4 md:items-center">
                ...
                <div className="w-5/6">
                  <h3 className="font-semibold text-lg text-gray-700 dark:text-teal-300">All-in-One Platform</h3>
