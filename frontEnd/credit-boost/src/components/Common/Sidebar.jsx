        ...
        >
            <div>
                <div className="-mx-6 px-6 py-4">
                    <Link href="/home" title="home" className='flex flex-row items-center gap-2'>
                        <img src="logo_d.png" className="w-10" alt=" logo" />
                        <p className='text-gray-100'>TurboBrok</p>
                    </Link>
                </div>
                ...
                <div className="mt-8 text-center">
                    <img
                        ...
                        alt=""
                        className="m-auto h-10 w-10 rounded-full object-cover lg:h-24 lg:w-24"
                    />
                        ...
                        >
                            ...
                            >
                                <path
                                    ...
                                    fillRule="evenodd"
                                    d="M4 2h12a2 2 0 012 2v3h-1a2 2 0 01-2-2V4H5v1a2 2 0 01-2 2H2V4a2 2 0 012-2z"
                                    clipRule="evenodd"
                                />
                                <path
                                    className="fill-current text-gray-600 group-hover:text-cyan-600 dark:group-hover:text-sky-400"
                                    d="M2 8h16l-1 9a2 2 0 01-2 2H5a2 2 0 01-2-2L2 8z"
                                />
                            </svg>

                            <span className="group-hover:text-gray-700 dark:group-hover:text-gray-50">Sell</span>
                        </a>
                    </li>
                    <li>
                        <a
                        ...
                        >
                            ...
                            <span className="group-hover:text-gray-700 dark:group-hover:text-gray-50">Leads</span>
                        </a>
                    </li>
                    {/* <li>
                        <a
